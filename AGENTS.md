...
- Use the Coolors palette `#ED2839`, `#FF7538`, `#FFEF00`, `#11EE11`, `#00CCFF`, `#1F75FE`, `#836DE8`, and `#FF66CC` for expressive accents. Blue drives primary actions, cyan selection, yellow/orange/green map to `TO-DO`/`DOING`/`DONE`, violet represents Archivo, pink identifies custom columns, and red remains semantic for warnings and destructive actions.

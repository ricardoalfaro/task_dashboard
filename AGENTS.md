...
- The palette currently under evaluation is `#D62839`, `#BA324F`, `#175676`, `#4BA3C3`, and `#CCE6F4`. Dark blue drives primary actions, medium blue interaction, pale blue selection and surfaces, burgundy represents Archivo and custom columns, and red remains semantic for warnings and destructive actions. Once the final palette is approved, centralize all color roles into semantic CSS variables.

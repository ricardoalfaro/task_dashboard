...
4. **Acceso externo**
   ...
   Supabase Auth administra las sesiones. El rol `owner` conserva la edición completa y puede crear, administrar o revocar miembros por correo desde Configuración; el rol `viewer` entra directamente a Reportes y solo puede consultar métricas y detalle de tareas.
